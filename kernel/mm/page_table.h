...
#define L2_PAGE_SIZE (PAGE_SIZE * L2_PER_ENTRY_PAGES)
#define L1_PAGE_SIZE (PAGE_SIZE * L1_PER_ENTRY_PAGES)
...
typedef union {
    struct {
        u64 is_valid : 1, is_table : 1, ignored1 : 10, next_table_addr : 36,
    ...
    struct {
        u64 is_valid : 1, is_table : 1,
            ...
            GP : 1, reserved4 : 1, DBM : 1,  // Dirty bit modifier
    ...
    u64 pte;  // just an alias of the entry
} pte_t;
